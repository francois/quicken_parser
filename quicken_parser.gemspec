Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE", "README", "Rakefile", "TODO", "lib/quicken_parser", "lib/quicken_parser/account.rb", "lib/quicken_parser/parser.rb", "lib/quicken_parser/transaction.rb", "lib/quicken_parser/transactions.rb", "lib/quicken_parser.rb", "test/account_test.rb", "test/fixtures", "test/fixtures/no_memo.txt", "test/fixtures/one_account.txt", "test/fixtures/one_cc.txt", "test/fixtures/two_accounts.txt", "test/parser_test.rb", "test/test_helper.rb", "test/transaction_test.rb", "test/transactions_test.rb"]
  s.has_rdoc = true
  ...
  if s.respond_to? :specification_version then
    ...
    if current_version >= 3 then
      s.add_runtime_dependency(%q<money>, ["~> 1.7"])
      s.add_development_dependency(%q<thoughtbot-shoulda>, ["~> 2.0"])
    else
      s.add_dependency(%q<money>, ["~> 1.7"])
